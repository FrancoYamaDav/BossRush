...
Shader "Holo"
{
	...
	SubShader
	{
		...
		{
			float4 color92 = IsGammaSpace() ? float4(0.4656907,0.687283,0.8584906,0) : float4(0.1836478,0.4300916,0.7077566,0);
			...
			float4 color126 = IsGammaSpace() ? float4(0,0.8924336,1,0) : float4(0,0.7725226,1,0);
			o.Albedo = ( ( color92 * ( tex2DNode109 * 2.0 ) ) + ( ( 1.0 - tex2DNode109 ) * color126 ) ).rgb;
			o.Alpha = ( 0.75 - 0.0 );
		}
...
/*ASEBEGIN
Version=18900
0;419.2;1037.4;403.8;894.2661;107.6826;4.594825;True;True
...
Node;AmplifyShaderEditor.ColorNode;126;900.0275,-229.0652;Inherit;False;Constant;_Color0;Color 0;4;0;Create;True;0;0;0;False;0;False;0,0.8924336,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;92;830.8134,-833.8382;Inherit;False;Constant;_Color1;Color 1;6;0;Create;True;0;0;0;False;0;False;0.4656907,0.687283,0.8584906,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=55C51758324FCE06231E817B4C5A585C2260BCB8