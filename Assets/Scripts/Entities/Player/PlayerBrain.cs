...
public class PlayerBrain
{
    ...
    public void RefreshKeybinds()
    {
        ...
        _commands.Add(_keybinds.hitDistance, new IsGrabbingObject(new ThrowObject(_pc, _cameraTransform), new HitDistance(_pc.GetProyectileSpawner(), _cameraTransform), _pc) );
